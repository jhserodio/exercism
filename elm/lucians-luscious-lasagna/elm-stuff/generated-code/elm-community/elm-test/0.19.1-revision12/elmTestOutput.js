...
var $author$project$LuciansLusciousLasagna$preparationMunitesPerLayer = 2;
var $author$project$LuciansLusciousLasagna$preparationTimeInMinutes = function (layers) {
	return $author$project$LuciansLusciousLasagna$preparationMunitesPerLayer * layers;
};
var $author$project$LuciansLusciousLasagna$elapsedTimeInMinutes = F2(
	function (layers, minutes) {
		return $author$project$LuciansLusciousLasagna$preparationTimeInMinutes(layers) + minutes;
	});
...
var pipeFilename = "/tmp/elm_test-96430.sock";
var net = require('net'),
